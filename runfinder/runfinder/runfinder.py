...
## Calls to runfinder are intended only to be made via its core algortihm find_run()
###############################################################################################################
...
class GoogleDEM:
    ...
    def __init__(self, bounds, output_dir):
        ...
        img = ee.Image('USGS/SRTMGL1_003').clip(area) # DEM
...
class PixelLite:
    ...
    def __init__(self, x, y, value, raster_meta):
        ...
        # the method I'm using will sometimes add the center, middle element 
        # as I've used that as a default to set values to 
        # if there is an out of bounds error. So let's just pop that off...
